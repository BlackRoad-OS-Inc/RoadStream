...
- [ ] [RC] Integrate RoadStream with RoundTrip hub (roundtrip.blackroad.io) for agent coordination
- [ ] [RC] Register RoadStream Agent in the BlackRoad Agent OS roster (~/.blackroad-agents/)
- [ ] [RC] Deploy RoadStream to Pi fleet node: Lucidia (.38)
...
- [ ] [RC] Add NLP intent triggers: 'play media' / 'stream'
...
## Upstream Sync
- [ ] Track upstream Jellyfin releases
